...
switch($accion){
        case"Agregar":
           ...
           $sentenciaSQL= $conexion ->prepare("INSERT INTO alimentos_ancestrales (nombre, imagen,precio) VALUES (:nombre, :imagen, :precio);");
           ...
           header("Location:productos alimentos.php");
           break;

            case"Modificar":
                $sentenciaSQL= $conexion->prepare("UPDATE alimentos_ancestrales SET nombre=:nombre WHERE id=:id");
                $sentenciaSQL->bindParam(':nombre', $txtnameofproduct);
                $sentenciaSQL->bindParam(':id', $txtID);
                $sentenciaSQL->execute();
                
                if($txtimagen!=""){
                    $sentenciaSQL= $conexion->prepare("UPDATE alimentos_ancestrales SET imagen=:imagen WHERE id=:id");
                ...
                $sentenciaSQL= $conexion->prepare("UPDATE alimentos_ancestrales SET precio=:precio WHERE id=:id");
                $sentenciaSQL->bindParam(':precio', $txtprice);
                $sentenciaSQL->bindParam(':id', $txtID);
                $sentenciaSQL->execute(); 
                header("Location:productos alimentos.php");              
            ...
            case "Seleccionar":
                $sentenciaSQL= $conexion->prepare("SELECT * FROM alimentos_ancestrales WHERE id=:id");
                $sentenciaSQL->bindParam(':id', $txtID);
                $sentenciaSQL->execute();
            ...
            case "Borrar":
                ...
                $sentenciaSQL= $conexion->prepare("SELECT imagen FROM alimentos_ancestrales WHERE id=:id");
                $sentenciaSQL->bindParam(':id', $txtID);
                $sentenciaSQL->execute();
                $Productos=$sentenciaSQL->fetch(PDO::FETCH_LAZY); 
                ...
                $sentenciaSQL= $conexion->prepare("DELETE FROM alimentos_ancestrales WHERE id=:id");
                $sentenciaSQL->bindParam(':id', $txtID);
                $sentenciaSQL->execute();
                header("Location:productos alimentos.php");
                break; 
...
$sentenciaSQL= $conexion->prepare("SELECT * FROM alimentos_ancestrales");
$sentenciaSQL->execute();
